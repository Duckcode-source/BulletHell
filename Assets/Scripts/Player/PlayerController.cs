...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("Thông số Lộn nhào (Dodge Roll)")]
    public float rollSpeed = 12f;      // Tốc độ bay khi lộn
    public float rollDuration = 0.4f;  // Lộn kéo dài bao lâu (giây)
    public float rollCooldown = 1f;    // Thời gian nghỉ trước khi lộn tiếp
   ...
   public bool isRolling { get; private set; } = false;
    ...
    void Update()
    {
        ...
        {
            // --- KỊCH BẢN BÌNH THƯỜNG (Chỉ nhận phím khi không bị lộn) ---
